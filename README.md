...
* check to see that a valid first last name and email are entered
* no message required or rendered once submitted if no message input was entered
* check to see if correct error messages are rendering if requirements aren't met
* check if certain html elements exist
